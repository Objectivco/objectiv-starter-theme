 ...
 * @return array
 */
function obj_attr_site_header( $attr ) {
	$attr['id'] = 'site-header';
 ...
 * @return array
 */
function obj_attr_site_container( $attr ) {
 ...
 * @return array
 */
function obj_attr_site_inner( $attr ) {
	$attr['id'] = 'site-inner';
 ...
 * @return array
 */
function obj_attr_site_footer( $attr ) {
	$attr['id'] = 'site-footer';
 ...
 * @return array
 */
function obj_attr_content( $attr ) {
	$attr['id'] = 'content';
 ...
 * @return array
 */
function obj_attr_skip_link( $attr, $context ) {
	if ( ! empty( $context ) ) {
 ...
 * @return array
 */
function obj_attr_sidebar( $attr, $context ) {
	if ( ! empty( $context ) ) {

		$attr['class'] .= " sidebar-{$context}";
		$attr['id']     = "sidebar-{$context}";

		if ( $name = obj_get_sidebar_name( $context ) ) {
 ...
 * @return array
 */
function obj_attr_button( $attr, $context ) {
 ...
 * @return array
 */
function obj_attr_menu_toggle( $attr, $context ) {
	$attr = obj_attr_button( $attr, $context );
 ...
 * @return array
 */
function obj_attr_menu( $attr, $context ) {
	if ( ! empty( $context ) ) {
		$attr['id'] = "menu-{$context}";

		if ( ! $menu_name = obj_get_menu_location_name( $context ) ) {
 ...
 * @return array
 */
function obj_attr_nav( $attr, $context ) {
	if ( ! empty( $context ) ) {
		$attr['id'] = "nav-{$context}";
	}
 ...
 * @return array
 */
function obj_attr_site_branding( $attr ) {
 ...
 * @return array
 */
function obj_attr_site_title( $attr ) {
	$attr['id'] = 'site-title';
 ...
 * @return array
 */
function obj_attr_site_description( $attr ) {
 ...
 * @return array
 */
function obj_attr_entry_published( $attr ) {
 ...
 * @return array
 */
function obj_attr_entry_summary( $attr ) {
 ...
 * @return array
 */
function obj_attr_comment( $attr ) {
 ...
 * @return array
 */
function obj_attr_comment_published( $attr ) {
 ...
 * @return array
 */
function obj_attr_comment_permalink( $attr ) {
 ...
 */
function obj_attr_footer_widgets( $attr, $context ) {
	if ( empty( $context ) ) {
